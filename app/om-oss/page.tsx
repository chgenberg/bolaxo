        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              ...
              <h2 className="text-2xl font-bold text-text-dark mb-3">Vår mission</h2>
            ...
            <div className="card">
              ...
              <h2 className="text-2xl font-bold text-text-dark mb-3">Vår vision</h2>
              <p className="text-text-gray">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center">
              <div className="w-24 h-24 bg-primary-blue rounded-full flex items-center justify-center mx-auto mb-4 text-white text-3xl font-bold">
                EA
              </div>
