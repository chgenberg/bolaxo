...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // or handle payment with Stripe Elements
    }, 2000)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Link
          href="/priser"
          className="inline-flex items-center text-primary-blue hover:text-blue-700 mb-8"
        >
          ...
          <div className="lg:col-span-1 order-2 lg:order-1">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-6">
              ...
              <div className="border-t pt-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  <span>Moms (25%)</span>
                  <span>{Math.round(parseInt(plan.price) * 0.25)} kr</span>
                </div>
                <div className="flex justify-between font-bold text-lg pt-2 border-t">
                  <span>Totalt per månad</span>
                  <span>{Math.round(parseInt(plan.price) * 1.25)} kr</span>
                </div>
              </div>
          ...
          <div className="lg:col-span-2 order-1 lg:order-2">
            <div className="bg-white rounded-lg shadow-md p-6 lg:p-8">
              <h1 className="text-2xl font-bold text-text-dark mb-6">
                {user ? 'Slutför köp' : 'Skapa konto och slutför köp'}
              </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <label htmlFor="orgNumber" className="block text-sm font-medium text-text-dark mb-1">
                        Organisationsnummer *
                      </label>
                      <input
                        type="text"
                ...
                <div>
                  <label className="flex items-start">
                    ...
                    <span className="text-sm text-text-gray">
                      ...
                      {' '}och{' '}
                      <Link href="/integritetspolicy" className="text-primary-blue hover:underline">
                        integritetspolicyn
                      </Link>
