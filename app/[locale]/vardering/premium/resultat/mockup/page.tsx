...
**Measurement date:** 90 dagar efter respektive års slut för att ge tid för årsredovisning`
  ...
  actionPlan: {
    ...
    duringNegotiation: [
      "**Förbered omfattande datarum** med proaktiv adressering av röda flaggor\n\nSkapa dokument som förklarar varje röd flagga, vad som har gjorts för att adressera den, och vad som planeras. Detta visar framåtblickande ledning och minskar risk för att köparen använder röda flaggor som förhandlingskort.\n\n**Inkludera:**\n1) Dokumentation av alla kundrelationer\n2) Successionsplaner för nyckelpersoner\n3) IT-moderniseringsroadmap\n4) GDPR-compliance dokumentation\n5) Finansiella rapporter och prognoser",
      
      "**Engagera W&I insurance provider** tidigt i processen\n\nDetta kan minska köparens risk och därmed motivera högre värdering och lägre krav på warranties. W&I insurance täcker köparen för warranty claims och kan kosta 1-2% av köpeskillingen. Processen tar 4-6 veckor så bör påbörjas tidigt.",
      
      "**Behåll normal business operations** och undvik churn\n\nDet är kritiskt att verksamheten fortsätter att prestera normalt under förhandlingarna. Churn eller försämrade resultat kan ge köparen anledning att sänka priset eller dra sig ur.\n\n**Åtgärder:**\n- Implementera retention strategies för top kunder\n- Behåll fokus på försäljning\n- Undvik större förändringar som kan påverka resultatet",
      
      "**Veckovisa uppdateringar** till management team\n\nHåll teamet informerat utan att avslöja konfidentiella detaljer. Detta minskar osäkerhet och rykten som kan påverka moralen. Fokusera på positiva framsteg och nästa steg i processen.",
      
      "**Förhandla parallellt** med 2-3 parter för att skapa konkurrens\n\nDetta är kritiskt för att maximera värderingen. Konkurrens mellan köpare kan driva upp priset med 10-20%. Var transparent om att det finns flera intressenter men respektera konfidentialitet. Använd LOI (Letter of Intent) från flera parter för att skapa momentum.",
      
      "**Förbered för due diligence** med omfattande dokumentation\n\nKöparen kommer att genomföra omfattande due diligence. Förbered all dokumentation i förväg:\n- Finansiella statements\n- Kontrakt\n- IP-dokumentation\n- HR-dokumentation\n- Compliance-dokumentation\n\nDetta gör processen smidigare och minskar risk för avbrott eller förseningar.",
      
      "**Hantera förhandlingsdynamik** professionellt\n\nVar förberedd på hårda förhandlingar där köparen kan försöka driva ned priset eller kräva mer warranties. Håll fast vid din värdering och använd data för att motivera den. Var beredd på kompromisser men vet dina gränser. Använd M&A-rådgivare för att hantera förhandlingarna professionellt.",
      
      "**Skydda konfidentialitet** och undvik leakage\n\nInformation om försäljningen kan påverka kunder, leverantörer, och anställda negativt. Implementera strikta konfidentialitetsprotokoll och informera endast när nödvändigt. Var förberedd på kommunikationsplan om information läcker ut."
    ],
    postSale: [
      "**Smooth handover** enligt transition services agreement (TSA)\n\nKöparen kommer att behöva stöd under övergångsperioden. TSA definierar vilka tjänster säljaren ska tillhandahålla (t.ex. IT-support, HR-support, kundservice) och under vilken period (vanligtvis 3-12 månader). Detaljera TSA tidigt i processen för att undvika förhandlingar i sista minuten. Kostnader för TSA ska täcka säljarens kostnader plus margin.",
      
      "**Omfattande kommunikationsplan** till kunder och leverantörer\n\nInformera kunder och leverantörer professionellt om försäljningen. Fokusera på kontinuitet och att inget ändras för dem. Detta minskar risk för churn eller oro. Kommunikationen bör ske samtidigt eller strax efter public announcement. Förbered Q&A-dokument för vanliga frågor.",
      
      "**Retention program** för nyckelpersoner\n\nKöparen kommer att vilja behålla nyckelpersoner. Implementera retention bonusar och tydliga karriärvägar för att säkerställa att viktiga medarbetare stannar. Detta är kritiskt för kontinuitet och för att maximera earn-out potential.\n\n**Retention program kan inkludera:**\n1) Stay-on bonusar\n2) Karriärutveckling\n3) Equity participation\n4) Tydliga roller och ansvar",
      
      "**Knowledge transfer sessions** dokumenterade\n\nSäkerställ att all kunskap överförs från säljare till köpare.\n\n**Inkluderar:**\n1) Kundrelationer och historik\n2) Teknisk kunskap och system\n3) Processer och rutiner\n4) Branschinsikter och relationer\n\nDokumentera allt för att säkerställa att inget går förlorat. Knowledge transfer bör ske över 3-6 månader med regelbundna sessions.",
      
      "**Månadsvis uppföljning** av earn-out KPIs\n\nOm earn-out ingår är det kritiskt att följa upp prestationen regelbundet. Implementera månadsvisa business reviews där EBITDA och andra KPI:er diskuteras. Detta säkerställer att earn-out-målen nås och ger tid att korrigera om prestationen avviker. Använd samma accounting policies som under due diligence.",
      
      "**Integration planning** och execution\n\nKöparen kommer att vilja integrera bolaget i sin organisation. Var delaktig i integrationsplaneringen för att säkerställa smooth transition.\n\n**Kan inkludera:**\n1) Systemintegration\n2) Processharmonisering\n3) Organisationsförändringar\n4) Kulturintegration\n\nVar proaktiv men respektera köparens beslut.",
      
      "**Post-closing support** och relationship management\n\nBygg en positiv relation med köparen även efter försäljningen. Detta kan vara värdefullt för framtida samarbeten, referenser, eller potentiella framtida transaktioner. Var tillgänglig för frågor och support under övergångsperioden men respektera att köparen nu äger bolaget."
    ]
  }
}
